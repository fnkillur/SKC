...
<body class="bodyclz skin-blue sidebar-mini ">
	<div class="wrapper">
		<!-- Main Header -->
		<header class="main-header">
			<!-- Logo -->
			<a href="/notice/list" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
				<span class="logo-mini"><b>SKC</b></span> <!-- logo for regular state and mobile devices -->
				<span class="logo-lg"><b>SKC</b>Admin</span>
			</a>
			<!-- Header Navbar -->
