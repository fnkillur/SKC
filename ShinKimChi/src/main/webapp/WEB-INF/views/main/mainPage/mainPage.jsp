...
<div style="position: fixed; left: 20%; top: 200px; width: 60%; z-index: 2;">
	<form id="searchForm">
		...
		<input type="text" class="form-control" name="keyword" style="position:absolute; left: 17%; width: 78%;" placeholder="가까운 역을 입력해주세요.">
		<button type="button" id="searchBtn" class="btn btn-default" style="position: absolute; right: 0;">검색</button>
	</form>
</div>
<div style="position: fixed; left:0; top: 200px; width: 100%; z-index: 1;">
	<div id="carouse-wrap">
		<ul id="carousel" class="top_slider roundabout-holder"
			style="margin-top: 200px;">
			<li><span> <a class="view-project-button" href="#">View
						Project</a>
			</span> <img width="407" height="304"
				src="http://teslathemes.com/wp-content/themes/teslathemes/images/photos/top_theme.png"
				alt="Browser Frame"> <img
				src="http://teslathemes.com/wp-content/uploads/2014/06/Zero-WP-slider.png"
				alt="" class="slide" /></li>
			<li><span> <a class="view-project-button" href="#">View
						Project</a>
			</span> <img
			...
			<li><span> <a class="view-project-button" href="#">View
				...
				src="http://teslathemes.com/wp-content/uploads/2014/06/Sevenfold-WP-slider.png"
				alt="" class="slide" /></li>
			<li><span> <a class="view-project-button" href="#">View
						Project</a>
			</span> <img
...
<div id="map" style="position:fixed; top: 5%; left: 0; width: 0; height: 0; "></div>
...
$('#searchBtn').on("click", function(){
	if($('#searchForm').find("[name='st_x']").val()!="" || $('#searchForm').find("[name='keyword']").val() != ""){
		$('#searchForm').attr("action","/skc/main/searchMap/map").attr("method", "get").submit();
	}else{
		alert("gps 설정 또는 역을 입력해주세요.")
	}
});
